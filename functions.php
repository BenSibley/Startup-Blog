	...
	function ct_ct_theme_name_update_fields( $fields ) {
		...
		$fields['author'] =
			'<p class="comment-form-author">
	            ...
	            <input id="author" name="author" type="text" placeholder="' . __( "Jane Doe", "ct_theme_name" ) . '" value="' . esc_attr( $commenter['comment_author'] ) .
			'" size="30" ' . $aria_req . ' />
	        </p>';
		...
		$fields['email'] =
			'<p class="comment-form-email">
	            ...
	            <input id="email" name="email" type="email" placeholder="' . __( "name@email.com", "ct_theme_name" ) . '" value="' . esc_attr( $commenter['comment_author_email'] ) .
			'" size="30" ' . $aria_req . ' />
	        </p>';
