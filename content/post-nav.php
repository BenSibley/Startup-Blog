...
if( $previous_post ) {
	// text above the link
	$previous_text = __('Previous Post', 'business-blog');
	// if there is a title use it, else call it "The Previous Post"
	$previous_title = get_the_title( $previous_post ) ? get_the_title( $previous_post ) : __("The Previous Post", 'business-blog');
	// get the post link
...
// if there isn't a previous post
	...
	// text above the link
	$previous_text = __('No Older Posts', 'business-blog');
	// set the title to return to the blog
	$previous_title = __('Return to Blog', 'business-blog');
	// link to blog
...
if( $next_post ) {
	// text above the link
	$next_text = __('Next Post', 'business-blog');
	// if there is a title use it, else call it "The next Post"
	$next_title = get_the_title( $next_post ) ? get_the_title( $next_post ) : __("The Next Post", 'business-blog');
	// get the post link
...
// if there isn't a next post
	...
	// text above the link
	$next_text = __('No Newer Posts', 'business-blog');
	// set the title to return to the blog
	$next_title = __('Return to Blog', 'business-blog');
	// link to blog
	$next_link = home_url();
}
