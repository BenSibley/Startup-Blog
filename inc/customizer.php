...
function ct_ct_theme_name_add_customizer_content( $wp_customize ) {
	...
	$wp_customize->add_control( 'logo_size', array(
		'label'    => __( 'Adjust the size of the logo', 'ct_theme_name' ),
		'section'  => 'ct_ct_theme_name_logo_upload',
		'settings' => 'logo_size',
		'type'     => 'range',
		'input_attrs' => array(
		...
		if ( $social_site == 'email' ) {
			...
			if ( $social_site == 'skype' ) {
				...
				$wp_customize->add_control( $social_site, array(
					'type'        => 'url',
					'label'       => $label,
					'description' => sprintf( __( 'Accepts Skype link protocol (<a href="%s" target="_blank">learn more</a>)', 'ct_theme_name' ), 'https://www.competethemes.com/blog/skype-links-wordpress/' ),
					'section'     => 'ct_ct_theme_name_social_media_icons',
					'priority'    => $priority
				) );
			} else {
	...
	$wp_customize->add_setting( 'search_bar', array(
		'default'           => 'hide',
		'sanitize_callback' => 'ct_ct_theme_name_sanitize_show_hide'
	) );
	// control
 ...
 * Used in: search bar
 */
function ct_ct_theme_name_sanitize_show_hide( $input ) {
