...
function ct_business_blog_enqueue_customizer_scripts() {
	wp_enqueue_script( 'ct-business-blog-customizer-js', get_template_directory_uri() . '/js/build/customizer.min.js', array( 'jquery' ), '', true );
...
function ct_business_blog_enqueue_customizer_post_message_scripts() {
	wp_enqueue_script( 'ct-business-blog-customizer-post-message-js', get_template_directory_uri() . '/js/build/postMessage.min.js', array( 'jquery' ), '', true );
